...
//  追記なし(10/24 15:15) -> 結局追記した
                        || (op_code == `ADDIU)
//
// 追加設計 1 のヒント(14)：I 形式の命令 sw の追加、符号拡張を行う制御信号の記述
// TODO: 追記なし(10/24 15:28) -> 結局追記した
                        || (op_code == `SW)
//
//
//
